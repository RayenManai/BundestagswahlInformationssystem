...
if __name__ == '__main__':
    ...
    for i in range(1, 300):
        erstimme_generator(wahlkreisId=i, jahr=2017)
        erstimme_generator(wahlkreisId=i, jahr=2021)
        zweitstimme_generator(wahlkreisId=i, jahr=2017)
        zweitstimme_generator(wahlkreisId=i, jahr=2021)